...
<body>
	<form onsubmit="return validate()" action="CallingAdd_Menu" >
    <table>
        <tr>
            <td><label for="menuId">Menu ID*</label></td>
            <td><input type="number" id="menuId" name="menuId"></td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr>
            <td><label for="restaurantId">Restaurant ID*</label></td>
            <td><input type="number" id="restaurantId" name="restaurantId"></td>
        </tr>
        <tr>
