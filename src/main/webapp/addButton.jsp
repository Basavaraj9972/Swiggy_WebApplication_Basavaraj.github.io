...
<head>
    ...
    <style>
        ...
        .modal-content {
 			 ...
 			 position: fixed; /* Position relative for absolute positioning inside */
		}
		...
		.scrollable-content {
		  padding-top: 0; /* Adjust according to the height of the fixed header */
  		  padding-bottom: 0; /* Adjust according to the height of the fixed footer */
		  width: 50%;
		}
...
<div id="myModal" class="modal">
  ...
  <span class="close" onclick="closePopup()">&times;</span>
    ...
    <div class="scrollable-content">
      ...
      <input type="button" name="item1"><br><br>
      <label for="item1">Items</label>
      <input type="button" name="item1"><br><br>
      <label for="item1">Items</label>
      <input type="button" name="item1"><br><br>
      ...
      <input type="button" name="item1"><br><br>
      <!-- Add your items here -->
    <button class="add-to-cart-btn" onclick="closePopup()">Add to Cart</button>
</div>
